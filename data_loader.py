...
def preprocess_dataset(df, freq, future_steps=1, y_cols=None, add_target=False):
    ...
    df = df.asfreq(convert_m_to_min(freq)) # fill all areas where the diff of the timeindex is > 1min
